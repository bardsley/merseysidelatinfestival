      ...
      >
        <div className="row-start-2 md:row-start-1 md:col-span-5 text-center md:text-left ">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className='rounded-3xl md:w-full max-w-lg mx-auto mb-6 md:mb-12 bg-merseyblue-700 border-merseyblue-800 border text-white p-8 text-center z-30'>
              ...
              <p className=''>
                ...
                <button className={ `${packages.length == 1 && packages[0] == fullPassName ? "text-merseyred-500" : "text-white bg-merseyred-500 0"} text-xl border border-merseyred-500 rounded-md p-6 mt-6 z-30`} 
