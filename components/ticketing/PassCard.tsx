...
export const PassCard = ({passName, clickFunction, pass, priceModel, hasASaving, selected, basic}:
  {passName:string, clickFunction:any, pass:any, priceModel:string, hasASaving:boolean, selected:boolean, basic?:boolean}
) => {
  ...
  return (
    <div
      ...
      ring-1 ring-gray-900/10  text-white border border-richblack-500 hover:border-white cursor-pointer ${cardWidthClasses}`}
    >
