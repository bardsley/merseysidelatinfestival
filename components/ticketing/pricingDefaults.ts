...
export const passes: Passes = {
  ...
  'Dine and Dance Pass': { cost: 60, studentCost: 55, isAvailable: false, saving: 2, studentSaving: 7, combination: ['Saturday Dinner', 'Saturday Party'],  description: "Saturday evening is covered including your food" },
