...
export const passes: Passes = {
  ...
  'Party Pass': { cost: 45, studentCost: 35, isAvailable: true, saving: 7, studentSaving: 17, combination: ['Friday Party', 'Saturday Party', 'Sunday Party'], description: "Party away every single night, the ultimate party weekend", priceId: 'price_1NJDR8EWkmdeWsQPmNiH8eQ7'},
  'Early Bird Full Pass': { cost: 125, studentCost: 110, isAvailable: true, saving: 77, studentSaving: 45, combination: ['Friday Party', 'Saturday Classes', 'Saturday Dinner', 'Saturday Party', 'Sunday Classes', 'Sunday Party'],  description: "Everything the festival has at the best rate! If you're looking for the best deal this is it", priceId: 'price_1NIASKEWkmdeWsQP2voB5TZp' },
}
