...
export const passes: Passes = {
  ...
  'Early Bird Full Pass': { cost: 125, studentCost: 10, isAvailable: true, saving: 77, studentSaving: 45, combination: ['Friday Party', 'Saturday Classes', 'Saturday Dinner', 'Saturday Party', 'Sunday Classes', 'Sunday Party'],  description: "Everything the festival has at the best rate! If you're looking for the best deal this is it", priceId: 'price_1PZcpXEWkmdeWsQPzfUgTsFt' },
}
