...
blocks:
  ...
  - tagline: Online Meal Preferences
    ...
    text: >
      We'll be launching a way you can update your meal preferences using the
      email you provided and the ticket number emailed to you when you purchased
      your tickets or passes


      The deadline for meal preferences is midnight on 2nd November so you have
      loads of time (and we'll email you when it's ready)
    text2: ''
    actions:
