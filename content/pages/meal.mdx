...
blocks:
  ...
  - tagline: Online Meal Preferences
    ...
    text: >
      You'll need you ticket number and the email that you used to buy your
      ticket. 


      To be sat with your friends, make a code up (any word you like) type it in
      and send to your friends.


      Anyone with the same code will be sat together (if possible)


      Example codes, SalsaMates, BarryAndFriends, IlikeToMambo, RandomWord,
      Cheese
    text2: ''
    actions:
