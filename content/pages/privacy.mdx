...
blocks:
  - body: >
      ...
      * Clerk: We use Clerk to connect with Google and Facebook for
      authentication purposes and to store your authentication data securely.

      * Amazon AWS: We use Amazon Web Services to host and store our data
      ...
      * Contacting us using the contact information provided below
      ...
      Email: [salsa@salsaliverpool.co.uk](salsa@salsaliverpool.co.uk)
    _template: content
---
